...
export const Banner = () => {
    ...
    return (
        ...
        >
            ...
            >          
                <div className='md:absolute mt-10 h-[400px] w-[400px] md:w-full rounded-full overflow-hidden md:overflow-visible mx-auto  md:h-auto md:flex justify-end '>
                ...
                <div className=' z-20  tracking-wider md:mx-[70px] mt-3 md:mt-0  md:bg-white/70 lg:bg-transparent  rounded-lg py-7 px-5 m-5 md:px-5 '>
                    <div className=''>
