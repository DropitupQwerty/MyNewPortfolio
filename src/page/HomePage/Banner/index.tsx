...
export const Banner = () => {
    ...
    return (
        ...
        >
            <div className={' relative   w-full h-screen  items-center   flex flex-col sm:flex-row  sm:items-end  lg:items-center '} 
            >          
                <div className='transition-all  duration-200 flex   sm:absolute mt-[20vh] sm:mt-0 w-screen h-full'>
                    <div className=' rounded-full sm:rounded-none overflow-hidden sm:overflow-visible  h-[30vh] w-[30vh] sm:w-full  mx-auto sm:mx-0 transition-all duration-200 relative sm:left-0 lg:left-[40%] sm:bottom-[50%] md:bottom-[40%] lg:bottom-[10%]'>
                        
                        <img src={myImage} className={twMerge('rounded-full sm:w-[70%]  object-contain sm:h-[220vh]  transition-all duration-[200ms]' , currentView ? 'opacity-100' : 'opacity-0')}/>
                    </div>
                </div>
